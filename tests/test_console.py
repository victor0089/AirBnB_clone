...
class TestHBNBCommand_update(unittest.TestCase):
    ...
    def test_update_valid_string_attr_space_notation(self):
        with patch('sys.stdout', new=StringIO()) as output:
            ...
            testId = output.getvalue().strip()
        testCmd = \
            "update BaseModel {} attr_name 'attr_value'".format(testId)
        self.assertFalse(HBNBCommand().onecmd(testCmd))
        test_dict = \
            storage.all()['BaseModel.{}'.format(testId)].__dict__
        ...
        with patch('sys.stdout', new=StringIO()) as output:
            ...
            testId = output.getvalue().strip()
        testCmd = \
            "update State {} attr_name 'attr_value'".format(testId)
        self.assertFalse(HBNBCommand().onecmd(testCmd))
        ...
        with patch('sys.stdout', new=StringIO()) as output:
            ...
            testId = output.getvalue().strip()
        testCmd = \
            "update Place {} attr_name 'attr_value'".format(testId)
        self.assertFalse(HBNBCommand().onecmd(testCmd))
        ...
        with patch('sys.stdout', new=StringIO()) as output:
            ...
            testId = output.getvalue().strip()
        testCmd = \
            "update Amenity {} attr_name 'attr_value'".format(testId)
        self.assertFalse(HBNBCommand().onecmd(testCmd))
        ...
        with patch('sys.stdout', new=StringIO()) as output:
            ...
            testId = output.getvalue().strip()
        testCmd = \
            "update Review {} attr_name 'attr_value'".format(testId)
        self.assertFalse(HBNBCommand().onecmd(testCmd))
